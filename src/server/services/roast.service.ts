...
const roastOutputSchema = z.object({
  roastLines: z
    ...
    .length(10)
    .describe(
      "10 witty, data-driven, self-deprecating roast lines about the user's dating app performance",
    ),
  realTalkInsights: z
    .array(z.string())
    .min(3)
  ...
  overallScore: z
    ...
    .max(100)
    .describe(
      "Overall dateability score 0-100. Be honest but not cruel. Average user scores 35-55.",
    ),
});
