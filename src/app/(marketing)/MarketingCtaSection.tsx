...
export function MarketingCtaSection() {
  return (
    <div className="relative -z-10 px-6 lg:px-8">
      ...
      >
        <div
          className="aspect-[1108/632] w-[69.25rem] flex-none bg-linear-to-r from-[#ff80b5] to-[#E11D48] opacity-25"
          style={{
            clipPath:
      ...
      <div
        className="pointer-events-none absolute inset-x-0 top-full -z-10 hidden -translate-y-1/2 transform-gpu overflow-hidden blur-3xl sm:flex sm:justify-end"
        aria-hidden="true"
      >
        <div
          className="aspect-[1155/678] w-[72.1875rem] flex-none bg-linear-to-tr from-[#ff80b5] to-[#E11D48] opacity-30"
          style={{
            clipPath:
