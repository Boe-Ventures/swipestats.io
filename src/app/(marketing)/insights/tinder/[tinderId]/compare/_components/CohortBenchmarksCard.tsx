...
export function CohortBenchmarksCard() {
  ...
  const { data: primaryStats } = useQuery(
    trpc.cohort.getStats.queryOptions(
      ...
      { enabled: !!primaryCohort && hasPremiumAccess },
    ),
  );
      ...
      <CardContent>
        {hasPremiumAccess ? (
          <div className="space-y-4">
            ...
            {/* Show message if no cohorts loaded yet */}
            {!primaryStats && !genderStats && !globalStats && (
          ...
          <div className="rounded-lg border bg-linear-to-r from-pink-50 to-rose-50 p-6 dark:from-pink-950/50 dark:to-rose-950/50">
            <div className="space-y-4">
              <div>
                <h4 className="mb-2 font-semibold">Unlock Premium Insights</h4>
                <ul className="text-muted-foreground space-y-2 text-sm">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong>Percentile Rankings:</strong> See exactly where
                      you rank among similar users
                    </span>
                  </li>
                </ul>
              </div>
