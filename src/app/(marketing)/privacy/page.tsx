  ...
  return (
    <div>
      ...
      <div className="prose lg:prose-xl mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <ul>
          <li>A season-specific pseudonym generated by SwipeStats</li>
          <li>
        ...
        <p>
          ...
          provider or upload identifiers, raw match or right-swipe totals,
          messages, uploaded files, images, age, gender, interested-in gender,
          or location in the public leaderboard. The public pseudonym and
          technical row key change between months, quarters, years, and all-time
          competitions, so our API does not provide a stable identifier for
          linking one profile across seasons. Exact rank and rounded match yield
          can still be correlated with information published elsewhere, so a
          pseudonymous row may be recognizable even though we do not expose
          direct identifiers.
        </p>
        <p>
