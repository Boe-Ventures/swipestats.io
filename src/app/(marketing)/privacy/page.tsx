      ...
      <div className="prose lg:prose-xl mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              <td>Provide pseudonymous SwipeRank comparisons</td>
              <td>
                Legitimate interest (Art. 6(1)(f)); the underlying sensitive
                dating-data processing remains covered by the explicit consent
                described above
              </td>
            </tr>
          </tbody>
        ...
        <p>
          ...
          automatically under a stable pseudonym that links its results across
          seasons. This public leaderboard is separate from your private
          insights and from the anonymized research datasets described below.
        </p>
        <p>A public SwipeRank row may contain only:</p>
        <ul>
          <li>A stable pseudonym generated by SwipeStats</li>
          <li>
            Your exact competition rank, eligible field size, and derived top
            share
          </li>
          <li>
            Your observed match rate, meaning reported matches divided by right
            swipes, rounded to one decimal percentage point
          </li>
          <li>
            Exact match, right-swipe, and active-day counts for the selected
            season
          </li>
          <li>
            Current gender, interested-in gender, exact age in the season, city,
            region, and country when present in the uploaded data
          </li>
          <li>Exact observed-history length and number of eligible seasons</li>
          <li>
            An uploaded profile photo and photo count when stored for that
            profile
          </li>
          <li>
        ...
        <p>
          ...
          include an entry while the underlying profile remains eligible. If you
          delete the relevant profile or account, we remove it from the live
          leaderboard after the next cache refresh, but cannot retract copies or
          caches already made by third parties. Deletion does not identify or
          remove genuinely anonymized aggregate research or editorial statistics
