...
// Public share page for kind="profile_roast" ai_output rows (the vision roast
// of one profile-compare column).
import { useParams } from "next/navigation";
import Link from "next/link";
import { ExternalLink, Flame, Layers, MessageSquareText } from "lucide-react";
import { formatDistanceToNow } from "date-fns";

import { Button } from "@/components/ui/button";
import { Skeleton } from "@/components/ui/skeleton";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";
import { RoastView } from "@/components/roast/roast-view";
  ...
  if (!data) {
    return (
      <ShareNotFound
        ...
        description="This roast may have been deleted or is no longer shared."
      />
    );
  }
      ...
      <header className="from-muted/30 to-background border-b bg-linear-to-b">
        <div className="container mx-auto max-w-2xl px-4 py-6">
          <div className="flex items-start justify-between gap-4">
            ...
            <Link
              href="https://www.swipestats.io/try?source=roast_share"
              target="_blank"
            >
