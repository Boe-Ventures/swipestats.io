/**
 * Create the waitlist-messages topic in Resend
 *
 * Usage:
 *   bun src/scripts/resend/create-messages-topic.ts
 */
...
async function main() {
  ...
  console.log("🚀 Creating 'Waitlist Messages' topic...\n");

  try {
    const { data, error } = await resend.topics.create({
      name: "Waitlist Messages",
      description: "Notifications for Message Analysis feature launch",
