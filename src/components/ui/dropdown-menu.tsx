    ...
    <DropdownMenuPrimitive.Portal keepMounted={keepMounted}>
      ...
      >
        <DropdownMenuPrimitive.Popup
          ...
          className={cn(
            "bg-popover text-popover-foreground border-border/20 z-50 max-h-(--available-height) min-w-[8rem] origin-(--transform-origin) overflow-x-hidden overflow-y-auto rounded-md border p-1 shadow-md transition-[opacity,transform] outline-none data-ending-style:scale-95 data-ending-style:opacity-0 data-starting-style:scale-95 data-starting-style:opacity-0",
            className,
          )}
          {...props}
        />
...
function DropdownMenuSubContent({
  ...
  return (
    <DropdownMenuContent
      ...
      className={cn(
        "bg-popover text-popover-foreground border-border/20 z-50 min-w-[8rem] origin-(--transform-origin) overflow-hidden rounded-md border p-1 shadow-lg",
        className,
      )}
      align={align}
      alignOffset={alignOffset}
