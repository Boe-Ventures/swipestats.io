...
## Voice Techniques — USE THESE SPECIFICALLY

These are the concrete techniques that make the voice work. If your draft is missing these, it's not in voice. Period.

### 1. Parenthetical asides as a second voice track

Parentheticals are your inner monologue leaking onto the page. Use 5+ per post. They break formality, add personality, and make the reader feel like you're talking to them, not at them.

From our posts:
- "(sure, Jan)"
- "(if you ever get one)"
- "(ageism is real, folks)"
- "(bless her heart for still loving you)"
- "(wink wink)"
- "(that comes later)"

### 2. Named pop culture references

Never use a generic metaphor when a specific cultural reference hits harder. Ground your writing in shared reality. Name names.

- YES: "emotional resilience of a Nokia 3310"
- YES: "You don't need to look like Chris Hemsworth"
- YES: "drier than Gandhi's flip-flops during a desert marathon"
- NO: "tough as nails" (generic)
- NO: "like a screen saver" (technically a reference but not vivid enough)

### 3. The narrator is a character, not a voice

Paw Markus is a person with dating experience, opinions, and a name. Reference your own experience. Have a backstory. Talk like someone who's been in the trenches, not someone observing from the press box.

- "I'm Paw Markus, your honest guide through the online dating app wasteland"
- "My Tinder game is pretty tight and it still happens all the time"
- "I've swiped, matched, and probably ghosted more people on Tinder than you've had hot dinners"

### 4. Go HARDER on the insults

If nobody reading your post thinks "damn, that's harsh" at least once, you pulled your punches. The examples call readers "touch-starved", "socially inept losers", "desperate mess." The tone is love + brutality. A coach who cares about you but will not coddle you.

- TOO SOFT: "you might not be getting many matches"
- RIGHT LEVEL: "Is your phone drier than Gandhi's flip-flops during a desert marathon?"
- TOO SOFT: "consider upgrading your photos"
- RIGHT LEVEL: "If your pictures look like they were taken by a security camera in 2011, no prompt on Earth is saving you"

### 5. Section headers must be funny

Every H2 and H3 should have personality. A reader scanning the headers should already be entertained. SEO keywords can live in the header, but they share the space with a joke or an attitude.

- YES: "Stop Looking Like a Slob: Basic Grooming 101"
- YES: "Actually Talk to People (Novel Concept, Right?)"
- YES: "Photos That Don't Make People Cringe"
- NO: "Best Funny Hinge Prompts for Guys" (functional, boring)
- NO: "How to Write Better Answers" (informative, no personality)

### 6. Vary sentence rhythm aggressively

Don't just do short-short-short. The rhythm should feel like a conversation that speeds up and slows down.

Pattern: Long setup sentence that builds context. Short punch. Question? Direct answer. Fragment for emphasis. Then a longer paragraph where you actually build an argument and let a thought breathe for a moment before snapping back to a one-liner.

### 7. Break the fourth wall

Acknowledge you're writing a dating blog. Acknowledge the absurdity. This creates intimacy and separates you from every other content piece that pretends it's delivering Important Information.

- "Congratulations, you've taken the first step towards either finding the love of your life or developing a swiping-induced repetitive strain injury."
- "If that sounds like your idea of fun, dive in. If it sounds like your personal hell, maybe stick to meeting people through friends."
- "Sound enticing? Read on for more brutal advice."

### Voice Checklist (check before submitting)

Before declaring the content done, verify:
