...
ogTitle: "Hinge Openers That Make Replying Easy"
ogDescription: "Specific, playful first messages beat another generic hey."
...
<ProductCard
  ...
  title="Give your matches something better to open with"
  description="Rewrite generic Hinge prompts into specific, easy-to-answer conversation hooks that sound like you."
  buttonText="Improve my Hinge prompts"
/>
...
<ProductCard
  ...
  title="Make your profile easier to start a conversation with"
  description="Get honest feedback on the photos, prompts, and bio that give matches something worth responding to."
