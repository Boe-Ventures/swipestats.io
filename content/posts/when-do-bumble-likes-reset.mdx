...
According to [SwipeStats data](/blog/tinder-statistics) analyzing 294 million swipes, the most selective men (swiping right on only 3.3% of profiles) achieve a 14% match rate. That's 2.5 times higher than average. Meanwhile, men who swipe right on everyone get below-average results with just a 5.24% match rate.
...
Based on [SwipeStats data](/blog/bumble-statistics) analyzing 294 million swipes and 1.26 million matches, the median male match rate is 2.04%. That means the typical man gets 1-2 matches per 100 swipes.
