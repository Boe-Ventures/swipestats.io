...
Men are swimming upstream on Tinder. [SwipeStats data](/blog/tinder-statistics) shows the median man gets matched 2.04% of the time, while the median woman gets matched 41.27%. That's not an equal playing field.
