...
ogTitle: "What 294 Million Tinder Swipes Reveal"
ogDescription: "Real match rates, gender gaps, and behavior from 7,079 profiles."
...
<ProductCard
  product="insights"
  title="Put your Tinder numbers next to these benchmarks"
  description="Upload your Tinder export to calculate your own match rate, selectivity, activity, and conversation stats."
...
<ProductCard
  ...
  title="Compare two profile versions before you commit"
  description="Put your current bio, photos, and profile choices side by side with a sharper version before you send it live."
  buttonText="Compare my profile versions"
/>
