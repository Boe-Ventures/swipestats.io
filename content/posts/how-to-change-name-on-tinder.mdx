...
![Dark infographic titled Three routes out of the name you typed at 1 AM, with three method cards: change it on Facebook which updates within 24 hours, email Tinder Support which takes about 5 minutes, and delete and start over which costs all matches, messages and likes, above a pink band showing 90 days of retained deleted account data, 30 days of face check linkage, a 1 to 2 week new user boost, and Facebook's 60 day wait between name changes](/images/blog/how-to-change-name-on-tinder/infographic.png)
...
Here's how. Go to [the Tinder help center](https://www.help.tinder.com/hc/en-us). Hit "Contact Us" and submit a request. Choose "Trouble with account login" or general inquiry. Explain your situation clearly. Be specific. "My name is spelled wrong" works better than a five-paragraph essay about your identity journey.

![Tinder Support home page headed We're here, with a search bar and four category tiles for A Guide To Tinder, Troubleshooting, Security and Privacy, and Safety and Reporting, above Visit FAQs and Contact Us buttons](/images/blog/how-to-change-name-on-tinder/shot-1.png)

_Tinder Support home_
...
When all else fails, there's always the big red button. This is the only guaranteed method for people who signed up with a phone number, email, or Google account. It works. But it costs you everything. If you want the full walkthrough first, we have a whole guide on [how to delete your Tinder account](/blog/how-to-delete-tinder-account).
...
![Tinder Help Center article titled Delete your Tinder account, listing the four steps to delete from Tinder's Settings and the four steps to delete using the Manage My Account tool, followed by a note that accounts deleted within the last 90 days may be recreated](/images/blog/how-to-change-name-on-tinder/shot-2.png)

_Tinder Help Center deletion steps_
...
Same photos plus same phone equals a high risk of being flagged as a repeat account. And flagged accounts get [shadowbanned](/blog/tinder-shadowban). Which means you'll be swiping into the void while your profile sits invisible to everyone. Like shouting into a pillow. Very therapeutic. Very ineffective.
...
Same story, and we covered it in full in our guide on [how to change your age on Tinder](/blog/how-to-change-age-on-tinder). Locked at signup. Same three methods apply: Facebook sync, Tinder Support, or delete and restart. Tinder locks your age for the same fraud-prevention reasons it locks your name. If you lied about your age at signup, well, that's between you and your conscience.
...
- [Tinder Help Center](https://www.help.tinder.com/hc/en-us)
...
- [Tinder Help Center: Delete your Tinder account](https://www.help.tinder.com/hc/en-us/articles/6956972185229-Delete-your-Tinder-account)
