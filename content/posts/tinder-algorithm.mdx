...
- Our analysis of **294M swipes from 7,000+ profiles** shows the average male match rate is just **1.69%**. Women? **30%+**.
...
- The average male match rate in our dataset: **~1.69%**. That's roughly 1-2 matches per 100 right swipes. So if you swiped right on 100 women today, statistically you'd match with maybe one or two of them. Romantic, right?
