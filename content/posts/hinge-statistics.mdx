...
ogTitle: "The Real Numbers Behind Hinge"
ogDescription: "Users, match rates, demographics, and revenue in one data-backed view."
...
Want to see how your numbers stack up? Check our [aggregate insights](/upload) to compare against real benchmarks.
...
<ProductCard
  ...
  title="Fix the profile before you pay for more exposure"
  description="Get direct feedback on the photos, prompts, and bio that determine whether extra Hinge visibility actually helps."
...
<ProductCard
  product="insights"
  title="See where your Hinge results land in the distribution"
  description="Upload your Hinge export for your match activity, conversation patterns, and real cohort benchmarks."
