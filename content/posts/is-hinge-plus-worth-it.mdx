...
- **One creator’s comparison reported HingeX got 12 matches per 500 likes (2.4%), Free got 10 (2.0%), and Hinge+ got 8 (1.6%).** The difference is... not exactly life-changing.
...
**HingeX ($49.99/month)** gives you everything in Plus, and adds three features:

- **Skip the Line.** Your profile gets pushed higher in other people's feeds. Think of it as an always-on version of the [Hinge Boost](/blog/hinge-boost) you can buy on its own. HingeX also adds enhanced recommendations and Priority Likes. Compare the price difference shown in your account.
...
| Weekly free Rose | 1 | 1 | 1 |
| Skip the Line | No | No | Yes |

Check [Hinge’s subscription benefits](https://help.hinge.co/hc/en-us/articles/38014282744595-Subscription-and-Purchase-Benefits) for the current tier comparison.
...
You buy either tier from inside the app itself, under the gear icon in account settings. On iOS, Hinge lists both App Store billing and Hinge payment powered by Stripe. Check the offer and billing route shown to you.
...
HingeX includes Hinge+ and adds Skip the Line, enhanced recommendations, and Priority Likes. We compare the tiers in [Hinge X vs Hinge Plus](/blog/hinge-x-vs-hinge-plus).
