...
![Infographic titled How long does a Tinder selfie review take, showing a four-stage timeline: 5 to 30 minutes for a normal automated review, 24 to 48 hours when extra processing is needed, several days to weeks in the manual review queue, and indefinite when the review is stuck in purgatory](/images/blog/tinder-selfie-under-review/infographic.png)
...
![Tinder newsroom press release headlined Tinder to Expand Facial Verification Feature Across the U.S., Setting a New Standard for Dating Safety, dated Oct 22 2025, with a phone mockup showing a Frame your face selfie prompt](/images/blog/tinder-selfie-under-review/shot-2.png)
...
![Tinder Face Check Scan policy page explaining why a face scan is required, how the video selfie generates a FaceMap and FaceVector, and how that verification data is used](/images/blog/tinder-selfie-under-review/shot-1.png)

_Tinder policy page_
